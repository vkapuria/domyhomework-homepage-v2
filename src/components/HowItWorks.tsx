  ...
  return (
    <section className="relative py-12 sm:py-16 bg-white overflow-hidden" aria-labelledby="how-it-works-heading">
      ...
      <div className="relative max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 text-center z-10">
        ...
        >
          {/* Step 1 */}
          <div className="relative bg-white p-6 border-2 border-black rounded-md 
        ...
        <div className="mt-12">
          <a 
            href="#order-form"
            className="inline-block bg-neutral-900 text-white px-6 py-3 rounded-md font-semibold hover:bg-neutral-800 transition-colors"
          >
            Start Your Order
          </a>
        </div>
